...
Database::Command('REPLACE INTO battle_log SET battle_id = {battle_id}, battle_log_data = {battle_log_data}', ['battle_id' => intval($_GET['battle_id']), 'battle_log_data' => $_POST['battle_log_data']]);
