...
fn setup(input: Input, ai: &str) -> Ready {
	...
	ai!(ai, state, setup; greedy, randw, obst, lightning, shortest, weighted, connected, connected2, selfish);
...
fn play(input: Input, ai: &str) -> Play {
	...
	let e = ai!(ai, state, play; greedy, randw, obst, lightning, shortest, weighted, connected, connected2, selfish);
